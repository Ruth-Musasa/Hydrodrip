    ...
    <div>
      ...
      <section>
        <div className="w-11/12 lg:w-10/12 m-auto flex flex-col md:flex-row lg:gap-20 py-16">
          ...
          <div className="m-auto space-y-10 w-full md:w-1/2">
            ...
            <div className="flex gap-6 pb-10">
              <img className="w-[70px] h-[70px] rounded-full object-cover object-center" src="public/img/photo3.png" alt="avatar" />
        ...
        <div className="bg-gray-100 relative flex flex-col md:flex-row">
          <img src="public/img/Rectangle 588.png" alt="" className="w-0 md:w-4/12 2xl:w-1/2 rotate-180 invisible md:visible " />
          ...
          <img src="public/img/Rectangle 588.png" alt="" className="w-0 invisible md:visible md:w-4/12 2xl:w-1/2 " />
        </div>
        ...
        <div className="bg-primary-300 py-20">
          <div className="grid md:grid-cols-2 w-10/12 m-auto lg:gap-20">
            ...
            <img src="public/img/Group 33578.png" alt="" />
          </div>
        </div>
